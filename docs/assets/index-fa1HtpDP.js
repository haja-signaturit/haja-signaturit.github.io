...
`;document.addEventListener("DOMContentLoaded",()=>{const i=new URL(window.location.href),r=i.searchParams.get("hostUrl"),n=i.searchParams.get("signerId");!r||!n||(document.querySelector("#hostUrl").value=r,document.querySelector("#signatureId").value=n)});document.querySelector("#openIframe").addEventListener("click",()=>{c()});function c(){const i=document.querySelector("#hostUrl").value,r={redirectionMode:"IN"},n=document.querySelector("#signatureId").value,o=new URL(window.location.href);o.searchParams.set("hostUrl",i),o.searchParams.set("signerId",n),window.history.pushState({},"",o),window.addEventListener("pdsEvent",e=>{console.log("pdsEvent",e.detail)}),universignSigInit("iframeContainerId",n,r,i)}
